...
type ResourceClaimClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*resourcev1alpha1.ResourceClaimList, error)
...
func (c *resourceClaimsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*resourcev1alpha1.ResourceClaimList, error) {
...
// ResourceClaimsNamespacer can scope to objects within a namespace, returning a resourcev1alpha1client.ResourceClaimInterface.
type ResourceClaimsNamespacer interface {
	Namespace(string) resourcev1alpha1client.ResourceClaimInterface
}
