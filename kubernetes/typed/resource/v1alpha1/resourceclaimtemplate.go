...
type ResourceClaimTemplateClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*resourcev1alpha1.ResourceClaimTemplateList, error)
...
func (c *resourceClaimTemplatesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*resourcev1alpha1.ResourceClaimTemplateList, error) {
...
// ResourceClaimTemplatesNamespacer can scope to objects within a namespace, returning a resourcev1alpha1client.ResourceClaimTemplateInterface.
type ResourceClaimTemplatesNamespacer interface {
	Namespace(string) resourcev1alpha1client.ResourceClaimTemplateInterface
}
