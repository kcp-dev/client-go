...
func (c *ResourceV1alpha3ClusterClient) PodSchedulingContexts() kcpresourcev1alpha3.PodSchedulingContextClusterInterface {
...
func (c *ResourceV1alpha3Client) PodSchedulingContexts(namespace string) resourcev1alpha3.PodSchedulingContextInterface {
