...
func (c *storageClassesClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*storagev1.StorageClassList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(storageClassesResource, storageClassesKind, logicalcluster.Wildcard, opts), &storagev1.StorageClassList{})
	if obj == nil {
		return nil, err
	}
...
func (c *storageClassesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsstoragev1.StorageClassApplyConfiguration, opts metav1.ApplyOptions) (*storagev1.StorageClass, error) {
...
func (c *storageClassesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsstoragev1.StorageClassApplyConfiguration, opts metav1.ApplyOptions) (*storagev1.StorageClass, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
