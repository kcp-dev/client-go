...
func (c *clusterRolesClusterClient) Cluster(cluster logicalcluster.Name) rbacv1beta1client.ClusterRoleInterface {
	if cluster == logicalcluster.Wildcard {
		panic("A specific cluster must be provided when scoping, not the wildcard.")
	}

	return &clusterRolesClient{Fake: c.Fake, Cluster: cluster}
}
...
func (c *clusterRolesClient) Create(ctx context.Context, clusterRole *rbacv1beta1.ClusterRole, opts metav1.CreateOptions) (*rbacv1beta1.ClusterRole, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(clusterRolesResource, c.Cluster, clusterRole), &rbacv1beta1.ClusterRole{})
	if obj == nil {
		return nil, err
	}
...
func (c *clusterRolesClient) Update(ctx context.Context, clusterRole *rbacv1beta1.ClusterRole, opts metav1.UpdateOptions) (*rbacv1beta1.ClusterRole, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(clusterRolesResource, c.Cluster, clusterRole), &rbacv1beta1.ClusterRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1beta1.ClusterRole), err
...
func (c *clusterRolesClient) UpdateStatus(ctx context.Context, clusterRole *rbacv1beta1.ClusterRole, opts metav1.UpdateOptions) (*rbacv1beta1.ClusterRole, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(clusterRolesResource, c.Cluster, "status", clusterRole), &rbacv1beta1.ClusterRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1beta1.ClusterRole), err
...
func (c *clusterRolesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(clusterRolesResource, c.Cluster, name, opts), &rbacv1beta1.ClusterRole{})
	return err
}
...
func (c *clusterRolesClient) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	action := kcptesting.NewRootDeleteCollectionAction(clusterRolesResource, c.Cluster, listOpts)
...
func (c *clusterRolesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*rbacv1beta1.ClusterRole, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(clusterRolesResource, c.Cluster, name), &rbacv1beta1.ClusterRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1beta1.ClusterRole), err
...
func (c *clusterRolesClient) List(ctx context.Context, opts metav1.ListOptions) (*rbacv1beta1.ClusterRoleList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(clusterRolesResource, clusterRolesKind, c.Cluster, opts), &rbacv1beta1.ClusterRoleList{})
	if obj == nil {
		return nil, err
	}
...
func (c *clusterRolesClient) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.InvokesWatch(kcptesting.NewRootWatchAction(clusterRolesResource, c.Cluster, opts))
}
...
func (c *clusterRolesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*rbacv1beta1.ClusterRole, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterRolesResource, c.Cluster, name, pt, data, subresources...), &rbacv1beta1.ClusterRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1beta1.ClusterRole), err
...
func (c *clusterRolesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsrbacv1beta1.ClusterRoleApplyConfiguration, opts metav1.ApplyOptions) (*rbacv1beta1.ClusterRole, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterRolesResource, c.Cluster, *name, types.ApplyPatchType, data), &rbacv1beta1.ClusterRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1beta1.ClusterRole), err
...
func (c *clusterRolesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsrbacv1beta1.ClusterRoleApplyConfiguration, opts metav1.ApplyOptions) (*rbacv1beta1.ClusterRole, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(clusterRolesResource, c.Cluster, *name, types.ApplyPatchType, data, "status"), &rbacv1beta1.ClusterRole{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1beta1.ClusterRole), err
