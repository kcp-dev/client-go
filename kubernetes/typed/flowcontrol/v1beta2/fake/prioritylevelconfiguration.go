...
func (c *priorityLevelConfigurationsClusterClient) Cluster(cluster logicalcluster.Name) flowcontrolv1beta2client.PriorityLevelConfigurationInterface {
...
func (c *priorityLevelConfigurationsClient) Create(ctx context.Context, priorityLevelConfiguration *flowcontrolv1beta2.PriorityLevelConfiguration, opts metav1.CreateOptions) (*flowcontrolv1beta2.PriorityLevelConfiguration, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(priorityLevelConfigurationsResource, c.Cluster, priorityLevelConfiguration), &flowcontrolv1beta2.PriorityLevelConfiguration{})
	if obj == nil {
		return nil, err
	}
...
func (c *priorityLevelConfigurationsClient) Update(ctx context.Context, priorityLevelConfiguration *flowcontrolv1beta2.PriorityLevelConfiguration, opts metav1.UpdateOptions) (*flowcontrolv1beta2.PriorityLevelConfiguration, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(priorityLevelConfigurationsResource, c.Cluster, priorityLevelConfiguration), &flowcontrolv1beta2.PriorityLevelConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*flowcontrolv1beta2.PriorityLevelConfiguration), err
...
func (c *priorityLevelConfigurationsClient) UpdateStatus(ctx context.Context, priorityLevelConfiguration *flowcontrolv1beta2.PriorityLevelConfiguration, opts metav1.UpdateOptions) (*flowcontrolv1beta2.PriorityLevelConfiguration, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(priorityLevelConfigurationsResource, c.Cluster, "status", priorityLevelConfiguration), &flowcontrolv1beta2.PriorityLevelConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*flowcontrolv1beta2.PriorityLevelConfiguration), err
...
func (c *priorityLevelConfigurationsClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(priorityLevelConfigurationsResource, c.Cluster, name, opts), &flowcontrolv1beta2.PriorityLevelConfiguration{})
	return err
}
...
func (c *priorityLevelConfigurationsClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*flowcontrolv1beta2.PriorityLevelConfiguration, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(priorityLevelConfigurationsResource, c.Cluster, name), &flowcontrolv1beta2.PriorityLevelConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*flowcontrolv1beta2.PriorityLevelConfiguration), err
...
func (c *priorityLevelConfigurationsClient) List(ctx context.Context, opts metav1.ListOptions) (*flowcontrolv1beta2.PriorityLevelConfigurationList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(priorityLevelConfigurationsResource, priorityLevelConfigurationsKind, c.Cluster, opts), &flowcontrolv1beta2.PriorityLevelConfigurationList{})
	if obj == nil {
		return nil, err
	}
...
func (c *priorityLevelConfigurationsClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*flowcontrolv1beta2.PriorityLevelConfiguration, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(priorityLevelConfigurationsResource, c.Cluster, name, pt, data, subresources...), &flowcontrolv1beta2.PriorityLevelConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*flowcontrolv1beta2.PriorityLevelConfiguration), err
...
func (c *priorityLevelConfigurationsClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsflowcontrolv1beta2.PriorityLevelConfigurationApplyConfiguration, opts metav1.ApplyOptions) (*flowcontrolv1beta2.PriorityLevelConfiguration, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(priorityLevelConfigurationsResource, c.Cluster, *name, types.ApplyPatchType, data), &flowcontrolv1beta2.PriorityLevelConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*flowcontrolv1beta2.PriorityLevelConfiguration), err
...
func (c *priorityLevelConfigurationsClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsflowcontrolv1beta2.PriorityLevelConfigurationApplyConfiguration, opts metav1.ApplyOptions) (*flowcontrolv1beta2.PriorityLevelConfiguration, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(priorityLevelConfigurationsResource, c.Cluster, *name, types.ApplyPatchType, data, "status"), &flowcontrolv1beta2.PriorityLevelConfiguration{})
	if obj == nil {
		return nil, err
	}
	return obj.(*flowcontrolv1beta2.PriorityLevelConfiguration), err
