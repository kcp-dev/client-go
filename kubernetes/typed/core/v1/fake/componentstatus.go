...
func (c *componentStatusesClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*corev1.ComponentStatusList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(componentStatusesResource, componentStatusesKind, logicalcluster.Wildcard, opts), &corev1.ComponentStatusList{})
	if obj == nil {
		return nil, err
	}
...
// Watch returns a watch.Interface that watches the requested ComponentStatuses across all clusters.
func (c *componentStatusesClusterClient) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.InvokesWatch(kcptesting.NewRootWatchAction(componentStatusesResource, logicalcluster.Wildcard, opts))
}
...
func (c *componentStatusesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationscorev1.ComponentStatusApplyConfiguration, opts metav1.ApplyOptions) (*corev1.ComponentStatus, error) {
...
func (c *componentStatusesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationscorev1.ComponentStatusApplyConfiguration, opts metav1.ApplyOptions) (*corev1.ComponentStatus, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
