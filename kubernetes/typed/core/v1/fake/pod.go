...
func (c *podsClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*corev1.PodList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(podsResource, podsKind, logicalcluster.Wildcard, metav1.NamespaceAll, opts), &corev1.PodList{})
	if obj == nil {
		return nil, err
	}
...
func (c *podsClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationscorev1.PodApplyConfiguration, opts metav1.ApplyOptions) (*corev1.Pod, error) {
...
func (c *podsClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationscorev1.PodApplyConfiguration, opts metav1.ApplyOptions) (*corev1.Pod, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
