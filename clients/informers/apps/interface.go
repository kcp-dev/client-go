...
import (
	"github.com/kcp-dev/client-go/clients/informers/apps/v1"
	"github.com/kcp-dev/client-go/clients/informers/apps/v1beta1"
	"github.com/kcp-dev/client-go/clients/informers/apps/v1beta2"
