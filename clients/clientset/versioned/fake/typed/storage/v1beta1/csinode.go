...
func (c *cSINodesClusterClient) Cluster(cluster logicalcluster.Name) storagev1beta1client.CSINodeInterface {
...
func (c *cSINodesClient) Create(ctx context.Context, cSINode *storagev1beta1.CSINode, opts metav1.CreateOptions) (*storagev1beta1.CSINode, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(cSINodesResource, c.Cluster, cSINode), &storagev1beta1.CSINode{})
	if obj == nil {
		return nil, err
	}
...
func (c *cSINodesClient) Update(ctx context.Context, cSINode *storagev1beta1.CSINode, opts metav1.UpdateOptions) (*storagev1beta1.CSINode, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(cSINodesResource, c.Cluster, cSINode), &storagev1beta1.CSINode{})
	if obj == nil {
		return nil, err
	}
	return obj.(*storagev1beta1.CSINode), err
...
func (c *cSINodesClient) UpdateStatus(ctx context.Context, cSINode *storagev1beta1.CSINode, opts metav1.UpdateOptions) (*storagev1beta1.CSINode, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(cSINodesResource, c.Cluster, "status", cSINode), &storagev1beta1.CSINode{})
	if obj == nil {
		return nil, err
	}
	return obj.(*storagev1beta1.CSINode), err
...
func (c *cSINodesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(cSINodesResource, c.Cluster, name, opts), &storagev1beta1.CSINode{})
	return err
}
...
func (c *cSINodesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*storagev1beta1.CSINode, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(cSINodesResource, c.Cluster, name), &storagev1beta1.CSINode{})
	if obj == nil {
		return nil, err
	}
	return obj.(*storagev1beta1.CSINode), err
...
func (c *cSINodesClient) List(ctx context.Context, opts metav1.ListOptions) (*storagev1beta1.CSINodeList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(cSINodesResource, cSINodesKind, c.Cluster, opts), &storagev1beta1.CSINodeList{})
	if obj == nil {
		return nil, err
	}
...
func (c *cSINodesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*storagev1beta1.CSINode, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(cSINodesResource, c.Cluster, name, pt, data, subresources...), &storagev1beta1.CSINode{})
	if obj == nil {
		return nil, err
	}
	return obj.(*storagev1beta1.CSINode), err
...
func (c *cSINodesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsstoragev1beta1.CSINodeApplyConfiguration, opts metav1.ApplyOptions) (*storagev1beta1.CSINode, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(cSINodesResource, c.Cluster, *name, types.ApplyPatchType, data), &storagev1beta1.CSINode{})
	if obj == nil {
		return nil, err
	}
	return obj.(*storagev1beta1.CSINode), err
...
func (c *cSINodesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsstoragev1beta1.CSINodeApplyConfiguration, opts metav1.ApplyOptions) (*storagev1beta1.CSINode, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(cSINodesResource, c.Cluster, *name, types.ApplyPatchType, data, "status"), &storagev1beta1.CSINode{})
	if obj == nil {
		return nil, err
	}
	return obj.(*storagev1beta1.CSINode), err
