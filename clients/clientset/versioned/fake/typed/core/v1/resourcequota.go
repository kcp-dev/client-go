...
var resourceQuotasResource = schema.GroupVersionResource{Group: "core", Version: "V1", Resource: "resourcequotas"}
var resourceQuotasKind = schema.GroupVersionKind{Group: "core", Version: "V1", Kind: "ResourceQuota"}
...
func (c *resourceQuotasClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*corev1.ResourceQuotaList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(resourceQuotasResource, resourceQuotasKind, logicalcluster.Wildcard, metav1.NamespaceAll, opts), &corev1.ResourceQuotaList{})
	if obj == nil {
		return nil, err
	}
...
func (c *resourceQuotasClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationscorev1.ResourceQuotaApplyConfiguration, opts metav1.ApplyOptions) (*corev1.ResourceQuota, error) {
...
func (c *resourceQuotasClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationscorev1.ResourceQuotaApplyConfiguration, opts metav1.ApplyOptions) (*corev1.ResourceQuota, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
