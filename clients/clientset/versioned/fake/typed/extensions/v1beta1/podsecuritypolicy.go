...
func (c *podSecurityPoliciesClusterClient) Cluster(cluster logicalcluster.Name) extensionsv1beta1client.PodSecurityPolicyInterface {
...
func (c *podSecurityPoliciesClient) Create(ctx context.Context, podSecurityPolicy *extensionsv1beta1.PodSecurityPolicy, opts metav1.CreateOptions) (*extensionsv1beta1.PodSecurityPolicy, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(podSecurityPoliciesResource, c.Cluster, podSecurityPolicy), &extensionsv1beta1.PodSecurityPolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *podSecurityPoliciesClient) Update(ctx context.Context, podSecurityPolicy *extensionsv1beta1.PodSecurityPolicy, opts metav1.UpdateOptions) (*extensionsv1beta1.PodSecurityPolicy, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(podSecurityPoliciesResource, c.Cluster, podSecurityPolicy), &extensionsv1beta1.PodSecurityPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*extensionsv1beta1.PodSecurityPolicy), err
...
func (c *podSecurityPoliciesClient) UpdateStatus(ctx context.Context, podSecurityPolicy *extensionsv1beta1.PodSecurityPolicy, opts metav1.UpdateOptions) (*extensionsv1beta1.PodSecurityPolicy, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(podSecurityPoliciesResource, c.Cluster, "status", podSecurityPolicy), &extensionsv1beta1.PodSecurityPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*extensionsv1beta1.PodSecurityPolicy), err
...
func (c *podSecurityPoliciesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(podSecurityPoliciesResource, c.Cluster, name, opts), &extensionsv1beta1.PodSecurityPolicy{})
	return err
}
...
func (c *podSecurityPoliciesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*extensionsv1beta1.PodSecurityPolicy, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(podSecurityPoliciesResource, c.Cluster, name), &extensionsv1beta1.PodSecurityPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*extensionsv1beta1.PodSecurityPolicy), err
...
func (c *podSecurityPoliciesClient) List(ctx context.Context, opts metav1.ListOptions) (*extensionsv1beta1.PodSecurityPolicyList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(podSecurityPoliciesResource, podSecurityPoliciesKind, c.Cluster, opts), &extensionsv1beta1.PodSecurityPolicyList{})
	if obj == nil {
		return nil, err
	}
...
func (c *podSecurityPoliciesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*extensionsv1beta1.PodSecurityPolicy, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(podSecurityPoliciesResource, c.Cluster, name, pt, data, subresources...), &extensionsv1beta1.PodSecurityPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*extensionsv1beta1.PodSecurityPolicy), err
...
func (c *podSecurityPoliciesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsextensionsv1beta1.PodSecurityPolicyApplyConfiguration, opts metav1.ApplyOptions) (*extensionsv1beta1.PodSecurityPolicy, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(podSecurityPoliciesResource, c.Cluster, *name, types.ApplyPatchType, data), &extensionsv1beta1.PodSecurityPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*extensionsv1beta1.PodSecurityPolicy), err
...
func (c *podSecurityPoliciesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsextensionsv1beta1.PodSecurityPolicyApplyConfiguration, opts metav1.ApplyOptions) (*extensionsv1beta1.PodSecurityPolicy, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(podSecurityPoliciesResource, c.Cluster, *name, types.ApplyPatchType, data, "status"), &extensionsv1beta1.PodSecurityPolicy{})
	if obj == nil {
		return nil, err
	}
	return obj.(*extensionsv1beta1.PodSecurityPolicy), err
