...
func (c *runtimeClassesClusterClient) Cluster(cluster logicalcluster.Name) nodev1alpha1client.RuntimeClassInterface {
...
func (c *runtimeClassesClient) Create(ctx context.Context, runtimeClass *nodev1alpha1.RuntimeClass, opts metav1.CreateOptions) (*nodev1alpha1.RuntimeClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(runtimeClassesResource, c.Cluster, runtimeClass), &nodev1alpha1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
...
func (c *runtimeClassesClient) Update(ctx context.Context, runtimeClass *nodev1alpha1.RuntimeClass, opts metav1.UpdateOptions) (*nodev1alpha1.RuntimeClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(runtimeClassesResource, c.Cluster, runtimeClass), &nodev1alpha1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nodev1alpha1.RuntimeClass), err
...
func (c *runtimeClassesClient) UpdateStatus(ctx context.Context, runtimeClass *nodev1alpha1.RuntimeClass, opts metav1.UpdateOptions) (*nodev1alpha1.RuntimeClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(runtimeClassesResource, c.Cluster, "status", runtimeClass), &nodev1alpha1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nodev1alpha1.RuntimeClass), err
...
func (c *runtimeClassesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(runtimeClassesResource, c.Cluster, name, opts), &nodev1alpha1.RuntimeClass{})
	return err
}
...
func (c *runtimeClassesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*nodev1alpha1.RuntimeClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(runtimeClassesResource, c.Cluster, name), &nodev1alpha1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nodev1alpha1.RuntimeClass), err
...
func (c *runtimeClassesClient) List(ctx context.Context, opts metav1.ListOptions) (*nodev1alpha1.RuntimeClassList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(runtimeClassesResource, runtimeClassesKind, c.Cluster, opts), &nodev1alpha1.RuntimeClassList{})
	if obj == nil {
		return nil, err
	}
...
func (c *runtimeClassesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*nodev1alpha1.RuntimeClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(runtimeClassesResource, c.Cluster, name, pt, data, subresources...), &nodev1alpha1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nodev1alpha1.RuntimeClass), err
...
func (c *runtimeClassesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsnodev1alpha1.RuntimeClassApplyConfiguration, opts metav1.ApplyOptions) (*nodev1alpha1.RuntimeClass, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(runtimeClassesResource, c.Cluster, *name, types.ApplyPatchType, data), &nodev1alpha1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nodev1alpha1.RuntimeClass), err
...
func (c *runtimeClassesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsnodev1alpha1.RuntimeClassApplyConfiguration, opts metav1.ApplyOptions) (*nodev1alpha1.RuntimeClass, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(runtimeClassesResource, c.Cluster, *name, types.ApplyPatchType, data, "status"), &nodev1alpha1.RuntimeClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*nodev1alpha1.RuntimeClass), err
