...
func (c *roleBindingsClient) Create(ctx context.Context, roleBinding *rbacv1alpha1.RoleBinding, opts metav1.CreateOptions) (*rbacv1alpha1.RoleBinding, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(roleBindingsResource, c.Cluster, c.Namespace, roleBinding), &rbacv1alpha1.RoleBinding{})
	if obj == nil {
		return nil, err
	}
...
func (c *roleBindingsClient) Update(ctx context.Context, roleBinding *rbacv1alpha1.RoleBinding, opts metav1.UpdateOptions) (*rbacv1alpha1.RoleBinding, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(roleBindingsResource, c.Cluster, c.Namespace, roleBinding), &rbacv1alpha1.RoleBinding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1alpha1.RoleBinding), err
...
func (c *roleBindingsClient) UpdateStatus(ctx context.Context, roleBinding *rbacv1alpha1.RoleBinding, opts metav1.UpdateOptions) (*rbacv1alpha1.RoleBinding, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(roleBindingsResource, c.Cluster, "status", c.Namespace, roleBinding), &rbacv1alpha1.RoleBinding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1alpha1.RoleBinding), err
...
func (c *roleBindingsClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewDeleteActionWithOptions(roleBindingsResource, c.Cluster, c.Namespace, name, opts), &rbacv1alpha1.RoleBinding{})
	return err
}
...
func (c *roleBindingsClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*rbacv1alpha1.RoleBinding, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(roleBindingsResource, c.Cluster, c.Namespace, name), &rbacv1alpha1.RoleBinding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1alpha1.RoleBinding), err
...
func (c *roleBindingsClient) List(ctx context.Context, opts metav1.ListOptions) (*rbacv1alpha1.RoleBindingList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(roleBindingsResource, roleBindingsKind, c.Cluster, c.Namespace, opts), &rbacv1alpha1.RoleBindingList{})
	if obj == nil {
		return nil, err
	}
...
func (c *roleBindingsClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*rbacv1alpha1.RoleBinding, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(roleBindingsResource, c.Cluster, c.Namespace, name, pt, data, subresources...), &rbacv1alpha1.RoleBinding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1alpha1.RoleBinding), err
...
func (c *roleBindingsClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsrbacv1alpha1.RoleBindingApplyConfiguration, opts metav1.ApplyOptions) (*rbacv1alpha1.RoleBinding, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(roleBindingsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &rbacv1alpha1.RoleBinding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1alpha1.RoleBinding), err
...
func (c *roleBindingsClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsrbacv1alpha1.RoleBindingApplyConfiguration, opts metav1.ApplyOptions) (*rbacv1alpha1.RoleBinding, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(roleBindingsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data, "status"), &rbacv1alpha1.RoleBinding{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1alpha1.RoleBinding), err
