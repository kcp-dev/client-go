...
func (c *rolesClusterClient) Cluster(cluster logicalcluster.Name) kcprbacv1.RolesNamespacer {
...
func (c *rolesClient) Create(ctx context.Context, role *rbacv1.Role, opts metav1.CreateOptions) (*rbacv1.Role, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(rolesResource, c.Cluster, c.Namespace, role), &rbacv1.Role{})
	if obj == nil {
		return nil, err
	}
...
func (c *rolesClient) Update(ctx context.Context, role *rbacv1.Role, opts metav1.UpdateOptions) (*rbacv1.Role, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(rolesResource, c.Cluster, c.Namespace, role), &rbacv1.Role{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Role), err
...
func (c *rolesClient) UpdateStatus(ctx context.Context, role *rbacv1.Role, opts metav1.UpdateOptions) (*rbacv1.Role, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(rolesResource, c.Cluster, "status", c.Namespace, role), &rbacv1.Role{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Role), err
...
func (c *rolesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewDeleteActionWithOptions(rolesResource, c.Cluster, c.Namespace, name, opts), &rbacv1.Role{})
	return err
}
...
func (c *rolesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*rbacv1.Role, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(rolesResource, c.Cluster, c.Namespace, name), &rbacv1.Role{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Role), err
...
func (c *rolesClient) List(ctx context.Context, opts metav1.ListOptions) (*rbacv1.RoleList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(rolesResource, rolesKind, c.Cluster, c.Namespace, opts), &rbacv1.RoleList{})
	if obj == nil {
		return nil, err
	}
...
func (c *rolesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*rbacv1.Role, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(rolesResource, c.Cluster, c.Namespace, name, pt, data, subresources...), &rbacv1.Role{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Role), err
...
func (c *rolesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsrbacv1.RoleApplyConfiguration, opts metav1.ApplyOptions) (*rbacv1.Role, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(rolesResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &rbacv1.Role{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Role), err
...
func (c *rolesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsrbacv1.RoleApplyConfiguration, opts metav1.ApplyOptions) (*rbacv1.Role, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(rolesResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data, "status"), &rbacv1.Role{})
	if obj == nil {
		return nil, err
	}
	return obj.(*rbacv1.Role), err
