...
func (c *CertificatesV1beta1ClusterClient) Cluster(cluster logicalcluster.Name) certificatesv1beta1.CertificatesV1beta1Interface {
	if cluster == logicalcluster.Wildcard {
		panic("A specific cluster must be provided when scoping, not the wildcard.")
	}
	return &CertificatesV1beta1Client{Fake: c.Fake, Cluster: cluster}
}
