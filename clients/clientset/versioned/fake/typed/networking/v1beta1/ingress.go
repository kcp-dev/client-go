...
func (c *ingressesClusterClient) Cluster(cluster logicalcluster.Name) kcpnetworkingv1beta1.IngressesNamespacer {
...
func (c *ingressesClient) Create(ctx context.Context, ingress *networkingv1beta1.Ingress, opts metav1.CreateOptions) (*networkingv1beta1.Ingress, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(ingressesResource, c.Cluster, c.Namespace, ingress), &networkingv1beta1.Ingress{})
	if obj == nil {
		return nil, err
	}
...
func (c *ingressesClient) Update(ctx context.Context, ingress *networkingv1beta1.Ingress, opts metav1.UpdateOptions) (*networkingv1beta1.Ingress, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(ingressesResource, c.Cluster, c.Namespace, ingress), &networkingv1beta1.Ingress{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1beta1.Ingress), err
...
func (c *ingressesClient) UpdateStatus(ctx context.Context, ingress *networkingv1beta1.Ingress, opts metav1.UpdateOptions) (*networkingv1beta1.Ingress, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(ingressesResource, c.Cluster, "status", c.Namespace, ingress), &networkingv1beta1.Ingress{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1beta1.Ingress), err
...
func (c *ingressesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewDeleteActionWithOptions(ingressesResource, c.Cluster, c.Namespace, name, opts), &networkingv1beta1.Ingress{})
	return err
}
...
func (c *ingressesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*networkingv1beta1.Ingress, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(ingressesResource, c.Cluster, c.Namespace, name), &networkingv1beta1.Ingress{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1beta1.Ingress), err
...
func (c *ingressesClient) List(ctx context.Context, opts metav1.ListOptions) (*networkingv1beta1.IngressList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(ingressesResource, ingressesKind, c.Cluster, c.Namespace, opts), &networkingv1beta1.IngressList{})
	if obj == nil {
		return nil, err
	}
...
func (c *ingressesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*networkingv1beta1.Ingress, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(ingressesResource, c.Cluster, c.Namespace, name, pt, data, subresources...), &networkingv1beta1.Ingress{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1beta1.Ingress), err
...
func (c *ingressesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsnetworkingv1beta1.IngressApplyConfiguration, opts metav1.ApplyOptions) (*networkingv1beta1.Ingress, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(ingressesResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &networkingv1beta1.Ingress{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1beta1.Ingress), err
...
func (c *ingressesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsnetworkingv1beta1.IngressApplyConfiguration, opts metav1.ApplyOptions) (*networkingv1beta1.Ingress, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(ingressesResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data, "status"), &networkingv1beta1.Ingress{})
	if obj == nil {
		return nil, err
	}
	return obj.(*networkingv1beta1.Ingress), err
