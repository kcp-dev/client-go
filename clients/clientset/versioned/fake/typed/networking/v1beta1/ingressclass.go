...
func (c *ingressClassesClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*networkingv1beta1.IngressClassList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(ingressClassesResource, ingressClassesKind, logicalcluster.Wildcard, opts), &networkingv1beta1.IngressClassList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &networkingv1beta1.IngressClassList{ListMeta: obj.(*networkingv1beta1.IngressClassList).ListMeta}
	for _, item := range obj.(*networkingv1beta1.IngressClassList).Items {
...
func (c *ingressClassesClient) Create(ctx context.Context, ingressClass *networkingv1beta1.IngressClass, opts metav1.CreateOptions) (*networkingv1beta1.IngressClass, error) {
	...
	return obj.(*networkingv1beta1.IngressClass), err
}
...
func (c *ingressClassesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsnetworkingv1beta1.IngressClassApplyConfiguration, opts metav1.ApplyOptions) (*networkingv1beta1.IngressClass, error) {
...
func (c *ingressClassesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsnetworkingv1beta1.IngressClassApplyConfiguration, opts metav1.ApplyOptions) (*networkingv1beta1.IngressClass, error) {
	if applyConfiguration == nil {
		return nil, fmt.Errorf("applyConfiguration provided to Apply must not be nil")
	}
	data, err := json.Marshal(applyConfiguration)
