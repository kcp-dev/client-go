...
func (c *eventsClusterClient) Cluster(cluster logicalcluster.Name) kcpeventsv1beta1.EventsNamespacer {
...
func (c *eventsClient) Create(ctx context.Context, event *eventsv1beta1.Event, opts metav1.CreateOptions) (*eventsv1beta1.Event, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(eventsResource, c.Cluster, c.Namespace, event), &eventsv1beta1.Event{})
	if obj == nil {
		return nil, err
	}
...
func (c *eventsClient) Update(ctx context.Context, event *eventsv1beta1.Event, opts metav1.UpdateOptions) (*eventsv1beta1.Event, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(eventsResource, c.Cluster, c.Namespace, event), &eventsv1beta1.Event{})
	if obj == nil {
		return nil, err
	}
	return obj.(*eventsv1beta1.Event), err
...
func (c *eventsClient) UpdateStatus(ctx context.Context, event *eventsv1beta1.Event, opts metav1.UpdateOptions) (*eventsv1beta1.Event, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(eventsResource, c.Cluster, "status", c.Namespace, event), &eventsv1beta1.Event{})
	if obj == nil {
		return nil, err
	}
	return obj.(*eventsv1beta1.Event), err
...
func (c *eventsClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewDeleteActionWithOptions(eventsResource, c.Cluster, c.Namespace, name, opts), &eventsv1beta1.Event{})
	return err
}
...
func (c *eventsClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*eventsv1beta1.Event, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(eventsResource, c.Cluster, c.Namespace, name), &eventsv1beta1.Event{})
	if obj == nil {
		return nil, err
	}
	return obj.(*eventsv1beta1.Event), err
...
func (c *eventsClient) List(ctx context.Context, opts metav1.ListOptions) (*eventsv1beta1.EventList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(eventsResource, eventsKind, c.Cluster, c.Namespace, opts), &eventsv1beta1.EventList{})
	if obj == nil {
		return nil, err
	}
...
func (c *eventsClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*eventsv1beta1.Event, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(eventsResource, c.Cluster, c.Namespace, name, pt, data, subresources...), &eventsv1beta1.Event{})
	if obj == nil {
		return nil, err
	}
	return obj.(*eventsv1beta1.Event), err
...
func (c *eventsClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationseventsv1beta1.EventApplyConfiguration, opts metav1.ApplyOptions) (*eventsv1beta1.Event, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(eventsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &eventsv1beta1.Event{})
	if obj == nil {
		return nil, err
	}
	return obj.(*eventsv1beta1.Event), err
...
func (c *eventsClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationseventsv1beta1.EventApplyConfiguration, opts metav1.ApplyOptions) (*eventsv1beta1.Event, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(eventsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data, "status"), &eventsv1beta1.Event{})
	if obj == nil {
		return nil, err
	}
	return obj.(*eventsv1beta1.Event), err
