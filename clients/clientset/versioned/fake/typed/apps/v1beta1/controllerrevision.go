...
func (c *controllerRevisionsClusterClient) Cluster(cluster logicalcluster.Name) kcpappsv1beta1.ControllerRevisionsNamespacer {
...
func (c *controllerRevisionsClient) Create(ctx context.Context, controllerRevision *appsv1beta1.ControllerRevision, opts metav1.CreateOptions) (*appsv1beta1.ControllerRevision, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(controllerRevisionsResource, c.Cluster, c.Namespace, controllerRevision), &appsv1beta1.ControllerRevision{})
	if obj == nil {
		return nil, err
	}
...
func (c *controllerRevisionsClient) Update(ctx context.Context, controllerRevision *appsv1beta1.ControllerRevision, opts metav1.UpdateOptions) (*appsv1beta1.ControllerRevision, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(controllerRevisionsResource, c.Cluster, c.Namespace, controllerRevision), &appsv1beta1.ControllerRevision{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1beta1.ControllerRevision), err
...
func (c *controllerRevisionsClient) UpdateStatus(ctx context.Context, controllerRevision *appsv1beta1.ControllerRevision, opts metav1.UpdateOptions) (*appsv1beta1.ControllerRevision, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(controllerRevisionsResource, c.Cluster, "status", c.Namespace, controllerRevision), &appsv1beta1.ControllerRevision{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1beta1.ControllerRevision), err
...
func (c *controllerRevisionsClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewDeleteActionWithOptions(controllerRevisionsResource, c.Cluster, c.Namespace, name, opts), &appsv1beta1.ControllerRevision{})
	return err
}
...
func (c *controllerRevisionsClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*appsv1beta1.ControllerRevision, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(controllerRevisionsResource, c.Cluster, c.Namespace, name), &appsv1beta1.ControllerRevision{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1beta1.ControllerRevision), err
...
func (c *controllerRevisionsClient) List(ctx context.Context, opts metav1.ListOptions) (*appsv1beta1.ControllerRevisionList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(controllerRevisionsResource, controllerRevisionsKind, c.Cluster, c.Namespace, opts), &appsv1beta1.ControllerRevisionList{})
	if obj == nil {
		return nil, err
	}
...
func (c *controllerRevisionsClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*appsv1beta1.ControllerRevision, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(controllerRevisionsResource, c.Cluster, c.Namespace, name, pt, data, subresources...), &appsv1beta1.ControllerRevision{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1beta1.ControllerRevision), err
...
func (c *controllerRevisionsClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsappsv1beta1.ControllerRevisionApplyConfiguration, opts metav1.ApplyOptions) (*appsv1beta1.ControllerRevision, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(controllerRevisionsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &appsv1beta1.ControllerRevision{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1beta1.ControllerRevision), err
...
func (c *controllerRevisionsClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsappsv1beta1.ControllerRevisionApplyConfiguration, opts metav1.ApplyOptions) (*appsv1beta1.ControllerRevision, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(controllerRevisionsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data, "status"), &appsv1beta1.ControllerRevision{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1beta1.ControllerRevision), err
