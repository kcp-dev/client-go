...
func (c *deploymentsClusterClient) Cluster(cluster logicalcluster.Name) kcpappsv1.DeploymentsNamespacer {
...
func (c *deploymentsClient) Create(ctx context.Context, deployment *appsv1.Deployment, opts metav1.CreateOptions) (*appsv1.Deployment, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(deploymentsResource, c.Cluster, c.Namespace, deployment), &appsv1.Deployment{})
	if obj == nil {
		return nil, err
	}
...
func (c *deploymentsClient) Update(ctx context.Context, deployment *appsv1.Deployment, opts metav1.UpdateOptions) (*appsv1.Deployment, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(deploymentsResource, c.Cluster, c.Namespace, deployment), &appsv1.Deployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Deployment), err
...
func (c *deploymentsClient) UpdateStatus(ctx context.Context, deployment *appsv1.Deployment, opts metav1.UpdateOptions) (*appsv1.Deployment, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(deploymentsResource, c.Cluster, "status", c.Namespace, deployment), &appsv1.Deployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Deployment), err
...
func (c *deploymentsClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewDeleteActionWithOptions(deploymentsResource, c.Cluster, c.Namespace, name, opts), &appsv1.Deployment{})
	return err
}
...
func (c *deploymentsClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*appsv1.Deployment, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(deploymentsResource, c.Cluster, c.Namespace, name), &appsv1.Deployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Deployment), err
...
func (c *deploymentsClient) List(ctx context.Context, opts metav1.ListOptions) (*appsv1.DeploymentList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(deploymentsResource, deploymentsKind, c.Cluster, c.Namespace, opts), &appsv1.DeploymentList{})
	if obj == nil {
		return nil, err
	}
...
func (c *deploymentsClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*appsv1.Deployment, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(deploymentsResource, c.Cluster, c.Namespace, name, pt, data, subresources...), &appsv1.Deployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Deployment), err
...
func (c *deploymentsClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsappsv1.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*appsv1.Deployment, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(deploymentsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &appsv1.Deployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Deployment), err
...
func (c *deploymentsClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsappsv1.DeploymentApplyConfiguration, opts metav1.ApplyOptions) (*appsv1.Deployment, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(deploymentsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data, "status"), &appsv1.Deployment{})
	if obj == nil {
		return nil, err
	}
	return obj.(*appsv1.Deployment), err
...
func (c *deploymentsClient) GetScale(ctx context.Context, deploymentName string, options metav1.GetOptions) (*autoscalingv1.Scale, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetSubresourceAction(deploymentsResource, c.Cluster, "scale", c.Namespace, deploymentName), &autoscalingv1.Scale{})
	if obj == nil {
		return nil, err
	}
...
func (c *deploymentsClient) UpdateScale(ctx context.Context, deploymentName string, scale *autoscalingv1.Scale, opts metav1.UpdateOptions) (*autoscalingv1.Scale, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(deploymentsResource, c.Cluster, "scale", c.Namespace, scale), &autoscalingv1.Scale{})
	if obj == nil {
		return nil, err
	}
	return obj.(*autoscalingv1.Scale), err
...
func (c *deploymentsClient) ApplyScale(ctx context.Context, deploymentName string, applyConfiguration *applyconfigurationsautoscalingv1.ScaleApplyConfiguration, opts metav1.ApplyOptions) (*autoscalingv1.Scale, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(deploymentsResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &autoscalingv1.Scale{})
	if obj == nil {
		return nil, err
	}
	return obj.(*autoscalingv1.Scale), err
