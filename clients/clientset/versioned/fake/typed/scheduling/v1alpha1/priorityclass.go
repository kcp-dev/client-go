...
func (c *priorityClassesClusterClient) Cluster(cluster logicalcluster.Name) schedulingv1alpha1client.PriorityClassInterface {
...
func (c *priorityClassesClient) Create(ctx context.Context, priorityClass *schedulingv1alpha1.PriorityClass, opts metav1.CreateOptions) (*schedulingv1alpha1.PriorityClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(priorityClassesResource, c.Cluster, priorityClass), &schedulingv1alpha1.PriorityClass{})
	if obj == nil {
		return nil, err
	}
...
func (c *priorityClassesClient) Update(ctx context.Context, priorityClass *schedulingv1alpha1.PriorityClass, opts metav1.UpdateOptions) (*schedulingv1alpha1.PriorityClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(priorityClassesResource, c.Cluster, priorityClass), &schedulingv1alpha1.PriorityClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*schedulingv1alpha1.PriorityClass), err
...
func (c *priorityClassesClient) UpdateStatus(ctx context.Context, priorityClass *schedulingv1alpha1.PriorityClass, opts metav1.UpdateOptions) (*schedulingv1alpha1.PriorityClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(priorityClassesResource, c.Cluster, "status", priorityClass), &schedulingv1alpha1.PriorityClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*schedulingv1alpha1.PriorityClass), err
...
func (c *priorityClassesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(priorityClassesResource, c.Cluster, name, opts), &schedulingv1alpha1.PriorityClass{})
	return err
}
...
func (c *priorityClassesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*schedulingv1alpha1.PriorityClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(priorityClassesResource, c.Cluster, name), &schedulingv1alpha1.PriorityClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*schedulingv1alpha1.PriorityClass), err
...
func (c *priorityClassesClient) List(ctx context.Context, opts metav1.ListOptions) (*schedulingv1alpha1.PriorityClassList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(priorityClassesResource, priorityClassesKind, c.Cluster, opts), &schedulingv1alpha1.PriorityClassList{})
	if obj == nil {
		return nil, err
	}
...
func (c *priorityClassesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*schedulingv1alpha1.PriorityClass, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(priorityClassesResource, c.Cluster, name, pt, data, subresources...), &schedulingv1alpha1.PriorityClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*schedulingv1alpha1.PriorityClass), err
...
func (c *priorityClassesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsschedulingv1alpha1.PriorityClassApplyConfiguration, opts metav1.ApplyOptions) (*schedulingv1alpha1.PriorityClass, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(priorityClassesResource, c.Cluster, *name, types.ApplyPatchType, data), &schedulingv1alpha1.PriorityClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*schedulingv1alpha1.PriorityClass), err
...
func (c *priorityClassesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsschedulingv1alpha1.PriorityClassApplyConfiguration, opts metav1.ApplyOptions) (*schedulingv1alpha1.PriorityClass, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(priorityClassesResource, c.Cluster, *name, types.ApplyPatchType, data, "status"), &schedulingv1alpha1.PriorityClass{})
	if obj == nil {
		return nil, err
	}
	return obj.(*schedulingv1alpha1.PriorityClass), err
