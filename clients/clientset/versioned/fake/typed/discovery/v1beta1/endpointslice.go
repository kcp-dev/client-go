...
func (c *endpointSlicesClient) Create(ctx context.Context, endpointSlice *discoveryv1beta1.EndpointSlice, opts metav1.CreateOptions) (*discoveryv1beta1.EndpointSlice, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewCreateAction(endpointSlicesResource, c.Cluster, c.Namespace, endpointSlice), &discoveryv1beta1.EndpointSlice{})
	if obj == nil {
		return nil, err
	}
...
func (c *endpointSlicesClient) Update(ctx context.Context, endpointSlice *discoveryv1beta1.EndpointSlice, opts metav1.UpdateOptions) (*discoveryv1beta1.EndpointSlice, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateAction(endpointSlicesResource, c.Cluster, c.Namespace, endpointSlice), &discoveryv1beta1.EndpointSlice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*discoveryv1beta1.EndpointSlice), err
...
func (c *endpointSlicesClient) UpdateStatus(ctx context.Context, endpointSlice *discoveryv1beta1.EndpointSlice, opts metav1.UpdateOptions) (*discoveryv1beta1.EndpointSlice, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewUpdateSubresourceAction(endpointSlicesResource, c.Cluster, "status", c.Namespace, endpointSlice), &discoveryv1beta1.EndpointSlice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*discoveryv1beta1.EndpointSlice), err
...
func (c *endpointSlicesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewDeleteActionWithOptions(endpointSlicesResource, c.Cluster, c.Namespace, name, opts), &discoveryv1beta1.EndpointSlice{})
	return err
}
...
func (c *endpointSlicesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*discoveryv1beta1.EndpointSlice, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewGetAction(endpointSlicesResource, c.Cluster, c.Namespace, name), &discoveryv1beta1.EndpointSlice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*discoveryv1beta1.EndpointSlice), err
...
func (c *endpointSlicesClient) List(ctx context.Context, opts metav1.ListOptions) (*discoveryv1beta1.EndpointSliceList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewListAction(endpointSlicesResource, endpointSlicesKind, c.Cluster, c.Namespace, opts), &discoveryv1beta1.EndpointSliceList{})
	if obj == nil {
		return nil, err
	}
...
func (c *endpointSlicesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*discoveryv1beta1.EndpointSlice, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(endpointSlicesResource, c.Cluster, c.Namespace, name, pt, data, subresources...), &discoveryv1beta1.EndpointSlice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*discoveryv1beta1.EndpointSlice), err
...
func (c *endpointSlicesClient) Apply(ctx context.Context, applyConfiguration *applyconfigurationsdiscoveryv1beta1.EndpointSliceApplyConfiguration, opts metav1.ApplyOptions) (*discoveryv1beta1.EndpointSlice, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(endpointSlicesResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data), &discoveryv1beta1.EndpointSlice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*discoveryv1beta1.EndpointSlice), err
...
func (c *endpointSlicesClient) ApplyStatus(ctx context.Context, applyConfiguration *applyconfigurationsdiscoveryv1beta1.EndpointSliceApplyConfiguration, opts metav1.ApplyOptions) (*discoveryv1beta1.EndpointSlice, error) {
	...
	obj, err := c.Fake.Invokes(kcptesting.NewPatchSubresourceAction(endpointSlicesResource, c.Cluster, c.Namespace, *name, types.ApplyPatchType, data, "status"), &discoveryv1beta1.EndpointSlice{})
	if obj == nil {
		return nil, err
	}
	return obj.(*discoveryv1beta1.EndpointSlice), err
