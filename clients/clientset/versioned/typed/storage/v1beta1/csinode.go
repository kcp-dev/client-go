...
type CSINodesClusterInterface interface {
	Cluster(logicalcluster.Name) storagev1beta1client.CSINodeInterface
...
func (c *cSINodesClusterInterface) Cluster(name logicalcluster.Name) storagev1beta1client.CSINodeInterface {
