...
type MutatingWebhookConfigurationsClusterInterface interface {
	Cluster(logicalcluster.Name) admissionregistrationv1beta1client.MutatingWebhookConfigurationInterface
...
func (c *mutatingWebhookConfigurationsClusterInterface) Cluster(name logicalcluster.Name) admissionregistrationv1beta1client.MutatingWebhookConfigurationInterface {
