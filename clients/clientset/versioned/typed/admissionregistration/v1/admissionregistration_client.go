...
type AdmissionregistrationV1ClusterScoper interface {
	Cluster(logicalcluster.Name) admissionregistrationv1.AdmissionregistrationV1Interface
}
...
func (c *AdmissionregistrationV1ClusterClient) Cluster(name logicalcluster.Name) admissionregistrationv1.AdmissionregistrationV1Interface {
