...
type IngressClassesClusterInterface interface {
	Cluster(logicalcluster.Name) networkingv1client.IngressClassInterface
...
func (c *ingressClassesClusterInterface) Cluster(name logicalcluster.Name) networkingv1client.IngressClassInterface {
