...
type ObjectTracker interface {
	Cluster(clusterPath logicalcluster.Path) ScopedObjectTracker
...
func (o objectTrackerReact) List(action ListActionImpl) (runtime.Object, error) {
	return o.tracker.List(action.GetResource(), action.GetKind(), action.GetNamespace())
}

func (o objectTrackerReact) Cluster(clusterPath logicalcluster.Path) scopedObjectTrackerReact {
	return scopedObjectTrackerReact{o.tracker.Cluster(clusterPath)}
}

type scopedObjectTrackerReact struct {
	tracker ScopedObjectTracker
}

func (o scopedObjectTrackerReact) List(action ListActionImpl) (runtime.Object, error) {
	return o.tracker.List(action.GetResource(), action.GetKind(), action.GetNamespace(), action.ListOptions)
}

func (o scopedObjectTrackerReact) Get(action GetActionImpl) (runtime.Object, error) {
	return o.tracker.Get(action.GetResource(), action.GetNamespace(), action.GetName(), action.GetOptions)
}

func (o scopedObjectTrackerReact) Create(action CreateActionImpl) (runtime.Object, error) {
...
func (o scopedObjectTrackerReact) Update(action UpdateActionImpl) (runtime.Object, error) {
	ns := action.GetNamespace()
	gvr := action.GetResource()
	objMeta, err := meta.Accessor(action.GetObject())
	if err != nil {
...
func (o scopedObjectTrackerReact) Delete(action DeleteActionImpl) (runtime.Object, error) {
	err := o.tracker.Delete(action.GetResource(), action.GetNamespace(), action.GetName(), action.DeleteOptions)
	return nil, err
}

func (o scopedObjectTrackerReact) Apply(action PatchActionImpl) (runtime.Object, error) {
	ns := action.GetNamespace()
	gvr := action.GetResource()
...
func (o scopedObjectTrackerReact) Patch(action PatchActionImpl) (runtime.Object, error) {
	ns := action.GetNamespace()
	gvr := action.GetResource()
...
func (t *scopedTracker) Watch(gvr schema.GroupVersionResource, ns string, opts ...metav1.ListOptions) (watch.Interface, error) {
...
func (t *tracker) watch(gvr schema.GroupVersionResource, cluster logicalcluster.Path, ns string, opts ...metav1.ListOptions) (watch.Interface, error) {
	_, err := assertOptionalSingleArgument(opts)
	if err != nil {
		return nil, err
	}
...
func (t *scopedTracker) Get(gvr schema.GroupVersionResource, ns, name string, opts ...metav1.GetOptions) (runtime.Object, error) {
	_, err := assertOptionalSingleArgument(opts)
	if err != nil {
		return nil, err
	}
	...
	matchingObj, ok := objs[ClusterNamespacedName{Cluster: t.clusterPath, NamespacedName: types.NamespacedName{Namespace: ns, Name: name}}]
	if !ok {
		return nil, errNotFound
	}
...
func (t *scopedTracker) Create(gvr schema.GroupVersionResource, obj runtime.Object, ns string, opts ...metav1.CreateOptions) error {
	_, err := assertOptionalSingleArgument(opts)
	if err != nil {
		return err
	}
...
func (t *scopedTracker) Update(gvr schema.GroupVersionResource, obj runtime.Object, ns string, opts ...metav1.UpdateOptions) error {
	_, err := assertOptionalSingleArgument(opts)
	if err != nil {
		return err
	}
...
func (t *scopedTracker) Patch(gvr schema.GroupVersionResource, patchedObject runtime.Object, ns string, opts ...metav1.PatchOptions) error {
	_, err := assertOptionalSingleArgument(opts)
	if err != nil {
		return err
	}
...
func (t *scopedTracker) Apply(gvr schema.GroupVersionResource, applyConfiguration runtime.Object, ns string, opts ...metav1.PatchOptions) error {
	_, err := assertOptionalSingleArgument(opts)
	if err != nil {
		return err
	}
...
func (t *scopedTracker) Delete(gvr schema.GroupVersionResource, ns, name string, opts ...metav1.DeleteOptions) error {
	_, err := assertOptionalSingleArgument(opts)
	if err != nil {
		return err
	}
...
func (t *managedFieldObjectTracker) Cluster(clusterPath logicalcluster.Path) ScopedObjectTracker {
	return &scopedManagedFieldObjectTracker{
		ScopedObjectTracker: t.ObjectTracker.Cluster(clusterPath),
		scheme:              t.scheme,
...
type scopedManagedFieldObjectTracker struct {
	ScopedObjectTracker
	scheme          ObjectScheme
	objectConverter runtime.ObjectConvertor
	mapper          meta.RESTMapper
...
var _ ScopedObjectTracker = &scopedManagedFieldObjectTracker{}

func (t *scopedManagedFieldObjectTracker) Create(gvr schema.GroupVersionResource, obj runtime.Object, ns string, vopts ...metav1.CreateOptions) error {
	...
	liveObject, err := t.ScopedObjectTracker.Get(gvr, ns, objMeta.GetName(), metav1.GetOptions{})
	...
	return t.ScopedObjectTracker.Create(gvr, objWithManagedFields, ns, opts)
}

func (t *scopedManagedFieldObjectTracker) Update(gvr schema.GroupVersionResource, obj runtime.Object, ns string, vopts ...metav1.UpdateOptions) error {
	opts, err := assertOptionalSingleArgument(vopts)
	if err != nil {
		return err
	}
	...
	oldObj, err := t.ScopedObjectTracker.Get(gvr, ns, objMeta.GetName(), metav1.GetOptions{})
	if err != nil {
		return err
	}
	...
	return t.ScopedObjectTracker.Update(gvr, objWithManagedFields, ns, opts)
}

func (t *scopedManagedFieldObjectTracker) Patch(gvr schema.GroupVersionResource, patchedObject runtime.Object, ns string, vopts ...metav1.PatchOptions) error {
	opts, err := assertOptionalSingleArgument(vopts)
	if err != nil {
		return err
	}
	...
	return t.ScopedObjectTracker.Patch(gvr, objWithManagedFields, ns, vopts...)
}

func (t *scopedManagedFieldObjectTracker) Apply(gvr schema.GroupVersionResource, applyConfiguration runtime.Object, ns string, vopts ...metav1.PatchOptions) error {
	opts, err := assertOptionalSingleArgument(vopts)
	if err != nil {
		return err
	}
	...
	exists := true
	liveObject, err := t.ScopedObjectTracker.Get(gvr, ns, applyConfigurationMeta.GetName(), metav1.GetOptions{})
	if apierrors.IsNotFound(err) {
		exists = false
		liveObject, err = t.scheme.New(gvk)
		if err != nil {
	...
	if !exists {
		return t.ScopedObjectTracker.Create(gvr, objWithManagedFields, ns, metav1.CreateOptions{
			DryRun:          opts.DryRun,
			FieldManager:    opts.FieldManager,
			FieldValidation: opts.FieldValidation,
		})
	} else {
		return t.ScopedObjectTracker.Update(gvr, objWithManagedFields, ns, metav1.UpdateOptions{
			DryRun:          opts.DryRun,
			FieldManager:    opts.FieldManager,
			FieldValidation: opts.FieldValidation,
		})
...
func (t *scopedManagedFieldObjectTracker) fieldManagerFor(gvk schema.GroupVersionKind) (*managedfields.FieldManager, error) {
