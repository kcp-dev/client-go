...
type ResourceClaimClusterLister interface {
	...
	List(selector labels.Selector) (ret []*resourcev1alpha2.ResourceClaim, err error)
	// Cluster returns a lister that can list and get ResourceClaims in one workspace.
	Cluster(clusterName logicalcluster.Name) resourcev1alpha2listers.ResourceClaimLister
...
func (s *resourceClaimClusterLister) List(selector labels.Selector) (ret []*resourcev1alpha2.ResourceClaim, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*resourcev1alpha2.ResourceClaim))
	})
	return ret, err
}

// Cluster scopes the lister to one workspace, allowing users to list and get ResourceClaims.
func (s *resourceClaimClusterLister) Cluster(clusterName logicalcluster.Name) resourcev1alpha2listers.ResourceClaimLister {
	return &resourceClaimLister{indexer: s.indexer, clusterName: clusterName}
}

// resourceClaimLister implements the resourcev1alpha2listers.ResourceClaimLister interface.
...
func (s *resourceClaimLister) List(selector labels.Selector) (ret []*resourcev1alpha2.ResourceClaim, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*resourcev1alpha2.ResourceClaim))
	})
	return ret, err
}

// ResourceClaims returns an object that can list and get ResourceClaims in one namespace.
func (s *resourceClaimLister) ResourceClaims(namespace string) resourcev1alpha2listers.ResourceClaimNamespaceLister {
	return &resourceClaimNamespaceLister{indexer: s.indexer, clusterName: s.clusterName, namespace: namespace}
}

// resourceClaimNamespaceLister implements the resourcev1alpha2listers.ResourceClaimNamespaceLister interface.
...
func (s *resourceClaimNamespaceLister) List(selector labels.Selector) (ret []*resourcev1alpha2.ResourceClaim, err error) {
...
func (s *resourceClaimNamespaceLister) Get(name string) (*resourcev1alpha2.ResourceClaim, error) {
	...
	return obj.(*resourcev1alpha2.ResourceClaim), nil
}
