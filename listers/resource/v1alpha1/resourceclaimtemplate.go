...
type ResourceClaimTemplateClusterLister interface {
	...
	List(selector labels.Selector) (ret []*resourcev1alpha1.ResourceClaimTemplate, err error)
	// Cluster returns a lister that can list and get ResourceClaimTemplates in one workspace.
	Cluster(clusterName logicalcluster.Name) resourcev1alpha1listers.ResourceClaimTemplateLister
...
func (s *resourceClaimTemplateClusterLister) List(selector labels.Selector) (ret []*resourcev1alpha1.ResourceClaimTemplate, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*resourcev1alpha1.ResourceClaimTemplate))
	})
	return ret, err
}

// Cluster scopes the lister to one workspace, allowing users to list and get ResourceClaimTemplates.
func (s *resourceClaimTemplateClusterLister) Cluster(clusterName logicalcluster.Name) resourcev1alpha1listers.ResourceClaimTemplateLister {
	return &resourceClaimTemplateLister{indexer: s.indexer, clusterName: clusterName}
}

// resourceClaimTemplateLister implements the resourcev1alpha1listers.ResourceClaimTemplateLister interface.
...
func (s *resourceClaimTemplateLister) List(selector labels.Selector) (ret []*resourcev1alpha1.ResourceClaimTemplate, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*resourcev1alpha1.ResourceClaimTemplate))
	})
	return ret, err
}

// ResourceClaimTemplates returns an object that can list and get ResourceClaimTemplates in one namespace.
func (s *resourceClaimTemplateLister) ResourceClaimTemplates(namespace string) resourcev1alpha1listers.ResourceClaimTemplateNamespaceLister {
	return &resourceClaimTemplateNamespaceLister{indexer: s.indexer, clusterName: s.clusterName, namespace: namespace}
}

// resourceClaimTemplateNamespaceLister implements the resourcev1alpha1listers.ResourceClaimTemplateNamespaceLister interface.
...
func (s *resourceClaimTemplateNamespaceLister) List(selector labels.Selector) (ret []*resourcev1alpha1.ResourceClaimTemplate, err error) {
...
func (s *resourceClaimTemplateNamespaceLister) Get(name string) (*resourcev1alpha1.ResourceClaimTemplate, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(resourcev1alpha1.Resource("resourceclaimtemplates"), name)
	}
	return obj.(*resourcev1alpha1.ResourceClaimTemplate), nil
}
