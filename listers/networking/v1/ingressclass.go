...
type IngressClassClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) networkingv1listers.IngressClassLister
...
func (s *ingressClassClusterLister) Cluster(clusterName logicalcluster.Name) networkingv1listers.IngressClassLister {
