...
type NetworkPolicyClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) networkingv1listers.NetworkPolicyLister
...
func (s *networkPolicyClusterLister) Cluster(clusterName logicalcluster.Name) networkingv1listers.NetworkPolicyLister {
