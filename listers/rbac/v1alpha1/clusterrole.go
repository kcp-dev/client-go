...
type ClusterRoleClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) rbacv1alpha1listers.ClusterRoleLister
...
func (s *clusterRoleClusterLister) Cluster(clusterName logicalcluster.Name) rbacv1alpha1listers.ClusterRoleLister {
