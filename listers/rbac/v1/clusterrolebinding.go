...
type ClusterRoleBindingClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) rbacv1listers.ClusterRoleBindingLister
...
func (s *clusterRoleBindingClusterLister) Cluster(clusterName logicalcluster.Name) rbacv1listers.ClusterRoleBindingLister {
