...
type DeploymentClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) appsv1listers.DeploymentLister
...
func (s *deploymentClusterLister) Cluster(clusterName logicalcluster.Name) appsv1listers.DeploymentLister {
