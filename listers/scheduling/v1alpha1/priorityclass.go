...
type PriorityClassClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) schedulingv1alpha1listers.PriorityClassLister
...
func (s *priorityClassClusterLister) Cluster(clusterName logicalcluster.Name) schedulingv1alpha1listers.PriorityClassLister {
