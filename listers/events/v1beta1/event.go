...
type EventClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) eventsv1beta1listers.EventLister
...
func (s *eventClusterLister) Cluster(clusterName logicalcluster.Name) eventsv1beta1listers.EventLister {
