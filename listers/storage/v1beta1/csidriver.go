...
type CSIDriverClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) storagev1beta1listers.CSIDriverLister
...
func (s *cSIDriverClusterLister) Cluster(clusterName logicalcluster.Name) storagev1beta1listers.CSIDriverLister {
