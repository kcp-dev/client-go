...
type FlowSchemaClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) flowcontrolv1alpha1listers.FlowSchemaLister
...
func (s *flowSchemaClusterLister) Cluster(clusterName logicalcluster.Name) flowcontrolv1alpha1listers.FlowSchemaLister {
