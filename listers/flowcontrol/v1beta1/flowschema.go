...
type FlowSchemaClusterLister interface {
	...
	Cluster(clusterName logicalcluster.Name) flowcontrolv1beta1listers.FlowSchemaLister
...
func (s *flowSchemaClusterLister) Cluster(clusterName logicalcluster.Name) flowcontrolv1beta1listers.FlowSchemaLister {
