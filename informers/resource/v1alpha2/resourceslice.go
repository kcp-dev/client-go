...
type ResourceSliceClusterInformer interface {
	Cluster(logicalcluster.Name) upstreamresourcev1alpha2informers.ResourceSliceInformer
	Informer() kcpcache.ScopeableSharedIndexInformer
	Lister() resourcev1alpha2listers.ResourceSliceClusterLister
}
...
func (f *resourceSliceClusterInformer) Lister() resourcev1alpha2listers.ResourceSliceClusterLister {
	return resourcev1alpha2listers.NewResourceSliceClusterLister(f.Informer().GetIndexer())
}

func (f *resourceSliceClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamresourcev1alpha2informers.ResourceSliceInformer {
...
type resourceSliceInformer struct {
	...
	lister   upstreamresourcev1alpha2listers.ResourceSliceLister
}
...
func (f *resourceSliceInformer) Lister() upstreamresourcev1alpha2listers.ResourceSliceLister {
	return f.lister
}
