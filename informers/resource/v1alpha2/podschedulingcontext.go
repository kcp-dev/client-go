...
func (f *podSchedulingContextClusterInformer) Lister() resourcev1alpha2listers.PodSchedulingContextClusterLister {
	return resourcev1alpha2listers.NewPodSchedulingContextClusterLister(f.Informer().GetIndexer())
}

func (f *podSchedulingContextClusterInformer) Cluster(clusterName logicalcluster.Name) upstreamresourcev1alpha2informers.PodSchedulingContextInformer {
...
func (f *podSchedulingContextInformer) Lister() upstreamresourcev1alpha2listers.PodSchedulingContextLister {
	return f.lister
}
